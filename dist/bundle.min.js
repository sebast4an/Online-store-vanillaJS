  ...
  var e = {
      ...
      526: () => {
        window.addEventListener('DOMContentLoaded', function () {
          var e = document.querySelector('.modal-search--open'),
            t = document.querySelector('.modal-search'),
            n = document.querySelector('.modal-search--close'),
            r = document.createElement('div');
          r.classList.add('modal-search__behind'),
            e.addEventListener('click', function () {
              t.after(r), (n.style.display = 'block'), t.showModal();
            }),
            n.addEventListener('click', function () {
              t.close();
            }),
            t.addEventListener('close', function () {
              (n.style.display = ''), r.remove();
            });
          var o = document.querySelector('#newsletter__input'),
            a = document.querySelector('.newsletter .form .input__button');
          o.addEventListener('keypress', function () {
            a.classList.add('input__button--active');
          }),
            o.addEventListener('keyup', function () {
              0 == o.value.length && a.classList.remove('input__button--active');
            });
        });
      },
      263: () => {
        window.addEventListener('DOMContentLoaded', function () {
          document.querySelector('.navigation__hamburger').addEventListener('click', function () {
            document.querySelector('.hamburger__icon').classList.toggle('hamburger__icon--animate');
            var e = document.querySelector('.navigation__list');
            (e.style.animation = 'hamburgerListAnimation2 .3s ease-in-out reverse both'),
              setTimeout(function () {
                (e.style.animation = ''), e.classList.toggle('list--active');
              }, 300);
            var t = document.querySelector('.hamburger__title');
            (t.style.animation = 'hamburerTitleAnimate3 .2s ease-in-out reverse both'),
              setTimeout(function () {
                (t.style.animation = ''),
                  t.classList.toggle('hamburger__title--animation'),
                  'Menu' == t.innerText ? (t.innerText = 'Hide menu') : (t.innerText = 'Menu');
              }, 500);
          });
        });
      },
      666: e => {
        var t = (function (e) {
                ...
                return function (o, a) {
                  ...
                  for (n.method = o, n.arg = a; ; ) {
                    ...
                    if ('next' === n.method) n.sent = n._sent = n.arg;
                      ...
                      if (r === d) throw ((r = _), n.arg);
                      n.dispatchException(n.arg);
                    } else 'return' === n.method && n.abrupt('return', n.arg);
                    r = h;
                    var i = u(e, t, n);
                    if ('normal' === i.type) {
                      if (((r = n.done ? _ : p), i.arg === f)) continue;
                      return { value: i.arg, done: n.done };
                    }
                    'throw' === i.type && ((r = _), (n.method = 'throw'), (n.arg = i.arg));
                  }
                };
              })(e, n, c)),
              a
          ...
          var L = (v.prototype = m.prototype = Object.create(y));
          function x(e) {
          ...
          return (
            ...
            i(L, 'constructor', v),
            i(v, 'constructor', g),
            (g.displayName = i(v, s, 'GeneratorFunction')),
            ...
            x(k.prototype),
            i(k.prototype, c, function () {
              return this;
            }),
            (e.AsyncIterator = k),
            (e.async = function (t, n, r, o, a) {
              void 0 === a && (a = Promise);
              var c = new k(l(t, n, r, o), a);
            ...
            (M.prototype = {
              ...
              abrupt: function (e, t) {
                ...
                return (
                  (c.type = e),
                  (c.arg = t),
                  a ? ((this.method = 'next'), (this.next = a.finallyLoc), f) : this.complete(c)
                );
              },
      ...
      671: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/add-basket.svg';
      },
      794: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/basket.svg';
      },
      997: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/clock.svg';
      },
      902: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/facebook.svg';
      },
      673: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/instagram.svg';
      },
      661: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/mail.svg';
      },
      378: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/map-pin.svg';
      },
      193: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/phone.svg';
      },
      262: (e, t, n) => {
        'use strict';
      ...
      961: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/twitter.svg';
      },
      816: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/user.svg';
      },
      649: (e, t, n) => {
        'use strict';
        e.exports = n.p + 'assets/test_baner.jpg';
      },
    },
    t = {};
  function n(r) {
  ...
  (n.n = e => {
    ...
    (() => {
      ...
      var r,
        ...
        c = n(757),
        s = n.n(c),
        i = 'https://fakestoreapi.com/',
        l = function (e, t) {
          for (var n, r = new Set(), o = 0; r.size < e; o++)
            r.add((0, (n = t), Math.floor(Math.random() * (n - 0 + 1) + 0)));
          return r;
        },
        u = function (e) {
          e &&
        ...
        d = function (e) {
          ...
          r.addEventListener('mousedown', function (e) {
            e.preventDefault(), (o = !0), (t = e.pageX - r.offsetLeft), (n = r.scrollLeft);
          }),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 7:
                        if (((a = e.sent), (c = document.querySelector('.occasion')))) {
                          e.next = 11;
                          break;
                        }
                        return e.abrupt('return');
                      case 11:
                        u(c), p(a, c, n), (e.next = 18);
                        break;
                      case 15:
        ...
        _ = function (e, t, n) {
          ...
          l(n, e.length - 1).forEach(function (t) {
            return (function (e, t) {
              var n = document.createElement('section');
              n.classList.add('product__element'),
                n.classList.add('product__element--id'.concat(e[t].id)),
                (n.innerHTML =
              ...
              return s().wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((o = i + t), (a = document.querySelector(n)))) {
                          e.next = 4;
                          break;
                        }
                        return e.abrupt('return');
                      case 4:
                        return u(a), (e.prev = 5), (e.next = 8), fetch(o);
                      case 8:
                        return (c = e.sent), (e.next = 11), c.json();
                      case 11:
                        (l = e.sent), _(l, a, r), d('.product'), (e.next = 19);
                        break;
                      case 16:
                        (e.prev = 16),
                          (e.t0 = e.catch(5)),
                          (a.innerText = 'Error loading data. Please reload page.');
                      case 19:
                      case 'end':
                        return e.stop();
                    }
        ...
        m = function (e, t) {
          var n = document.querySelector('.news__posts');
          if (n) {
            var r = document.createDocumentFragment();
            l(t, e.length - 1).forEach(function (t) {
              return (function (e, t) {
                var n = document.createElement('div');
                n.classList.add('post__element'),
                  n.classList.add('post__element--'.concat(e[t].id)),
                  (n.innerHTML =
                    '\n                <img class="post__image" src="https://picsum.photos/300/300.webp/?random='
                      .concat(
                        t,
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          ((n = 'https://jsonplaceholder.typicode.com/posts'),
                          (r = document.querySelector('.news__posts')))
                        ) {
                          e.next = 6;
                          break;
                        }
                      ...
                      case 6:
                        u(r), d('.post');
                      case 8:
                        return (e.prev = 8), (e.next = 11), fetch(n);
                      case 11:
                        return (o = e.sent), (e.next = 14), o.json();
                      case 14:
                        (a = e.sent), m(a, t), (e.next = 21);
                        break;
                      case 18:
                        (e.prev = 18),
                          (e.t0 = e.catch(8)),
                          (r.innerText = 'Error loading data. Please reload page.');
                      case 21:
                      case 'end':
                        return e.stop();
                    }
            ...
            e &&
              (e.forEach(function (e) {
                return (
                  ...
                  (a = t.image),
                  (c = t.price),
                  (s = document.createElement('section')).classList.add('product__element'),
                  s.classList.add('product__element-id'.concat(r)),
                  (s.innerHTML =
                    '\n                  <figure class="product__border">\n                    <img class="product__img" src="'
                      .concat(
                        a,
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if (
                            ((r = ''.concat(i, 'products/category/').concat(t)),
                            (document.querySelector('.all-products__header--name').innerText =
                              decodeURI(t)),
                            (o = document.querySelector('.all-products__products')))
                          ) {
                            e.next = 6;
                            break;
                          }
                          return e.abrupt('return');
                        case 6:
                          return u(o), (e.prev = 7), (e.next = 10), fetch(r);
                        case 10:
                          return (a = e.sent), (e.next = 13), a.json();
                        case 13:
                          (c = e.sent), n(c, o), (e.next = 20);
                          break;
                        case 17:
                          (e.prev = 17), (e.t0 = e.catch(7)), console.log(e.t0);
                        case 20:
                        case 'end':
                          return e.stop();
                      }
      ...
      (r = document.querySelector('.content')),
        (o = {
          ...
          '/electronics': v,
          '/jewelery': v,
          '/men%27s%20clothing': v,
          '/women%27s%20clothing': v,
          '/product-id':
        ...
        (a = function (e) {
          if (
            ...
            'product-id' == e.slice(1, 11))
          )
            (document.title = 'Online Store - '.concat(e.slice(1))),
              (r.innerHTML = o['/product-id']),
              (n = e.slice(12)),
              (a = function (e, t) {
                var n = e.category,
                  r = e.description,
                  ...
                  c = e.price,
                  s = e.title;
                document.querySelector('.selected-product--name').innerText = s;
                var i,
                  l,
                  u = document.createElement('div');
                u.classList.add('product-card'),
                  (u.innerHTML =
                    '\n                <ul class="product-card__info">\n                  <li class="product-card__list">\n                    <span class="product-card__list--title">Product ID:</span>\n                    <span class="product-card__list--value">'
                      .concat(
                        o,
                      ...
                      .concat(a, '">\n                <h3 class="product-card__price">Price: ')
                      .concat(
                        c,
                  ...
                  i.forEach(function (e) {
                    ...
                    t.classList.add('product-card__description-list--item'),
                      (t.innerHTML = e),
                      l.appendChild(t);
                  }),
                  u.querySelector('.product-card__description-list').append(l),
                  (t.innerHTML = ''),
                  t.append(u);
              }),
              (function () {
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              if (
                                ((n = ''.concat(i, 'products/').concat(t)),
                                (r = document.querySelector('.selected-product__card')))
                              ) {
                                e.next = 4;
                                break;
                              }
                              return e.abrupt('return');
                            case 4:
                              return u(r), (e.prev = 5), (e.next = 8), fetch(n);
                            case 8:
                              return (o = e.sent), (e.next = 11), o.json();
                            case 11:
                              (c = e.sent), console.log(c), a(c, r), (e.next = 19);
                              break;
                            case 16:
                              (e.prev = 16), (e.t0 = e.catch(5)), console.log(e.t0);
                            case 19:
                            case 'end':
                              return e.stop();
                          }
            ...
            switch (e) {
              case '/login-panel':
                (document.title = 'Online Store - Sign up or Sign in'), (r.innerHTML = o[e]);
                break;
              case '/basket':
                (document.title = 'Online Store - '.concat(e.slice(1))), (r.innerHTML = o[e]);
                break;
              case '/electronics':
                (document.title = 'Online Store - '.concat(e.slice(1))),
                  (r.innerHTML = o[e]),
              ...
              case '/men%27s%20clothing':
                (document.title = 'Online Store - '.concat(decodeURI(e.slice(1)))),
                  (r.innerHTML = o[e]),
                  y('men%27s%20clothing');
                break;
              case '/women%27s%20clothing':
                (document.title = 'Online Store - '.concat(decodeURI(e.slice(1)))),
                  (r.innerHTML = o[e]),
                  y('women%27s%20clothing');
                break;
              default:
                (document.title = 'Online Store'),
                  (r.innerHTML = o['/']),
                  f('products', '.recommend__products', 10),
                  h(14, 2),
                  f('products', '.bestsellers__products', 4),
                  g(6);
            }
          var n, a;
        }),
        (r.innerHTML = o[window.location.pathname]),
