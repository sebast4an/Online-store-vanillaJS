    ...
    (() => {
      ...
      var r = n(757),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 7:
                        if (((i = e.sent), (u = document.querySelector('.occasion')))) {
                          e.next = 11;
                          break;
                        }
                        return e.abrupt('return');
                      case 11:
                        s(u), l(i, u, n), (e.next = 18);
                        break;
                      case 15:
        ...
        d = function (e, t, n) {
          ...
          c(n, e.length - 1).forEach(function (t) {
            return (function (e, t) {
              ...
              n.classList.add('product__element'),
                ...
                (n.innerHTML =
                  '\n                  <figure class="product__border">\n                    <img class="product__img" src="'
                    ...
                    .concat(e[t].id, '" class="product__name--link">\n                         ')
                    .concat(
                      e[t].title,
              ...
              return o().wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((c = a + t), (l = document.querySelector(n)))) {
                          e.next = 4;
                          break;
                        }
                        return e.abrupt('return');
                      case 4:
                        return s(l), (e.prev = 5), (e.next = 8), fetch(c);
                      case 8:
                        return (u = e.sent), (e.next = 11), u.json();
                      case 11:
                        (p = e.sent), d(p, l, r), i('.product'), (e.next = 19);
                        break;
                      case 16:
                        (e.prev = 16),
                          (e.t0 = e.catch(5)),
                          (l.innerText = 'Error loading data. Please reload page.');
                      case 19:
                      case 'end':
                        return e.stop();
                    }
        ...
        h = function (e, t) {
          ...
          if (n) {
            var r = document.createDocumentFragment();
            c(t, e.length - 1).forEach(function (t) {
              return (function (e, t) {
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 11:
                        return (a = e.sent), (e.next = 14), a.json();
                      case 14:
                        (c = e.sent), h(c, t), (e.next = 21);
                        break;
                      case 18:
                        (e.prev = 18),
                          (e.t0 = e.catch(8)),
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if (
                            ((r = ''.concat(a, 'products/category/').concat(t)),
                            (document.querySelector('.all-products__header--name').innerText =
                              decodeURI(t)),
                            (c = document.querySelector('.all-products__products')))
                          ) {
                            e.next = 6;
                            break;
                          }
                          return e.abrupt('return');
                        case 6:
                          return s(c), (e.prev = 7), (e.next = 10), fetch(r);
                        case 10:
                          return (i = e.sent), (e.next = 13), i.json();
                        case 13:
                          (l = e.sent), n(l, c), (e.next = 20);
                          break;
                        case 17:
        ...
        g = document.querySelector('.content'),
        v = {
          ...
          '/electronics': f,
          '/jewelery': f,
          '/men%27s%20clothing': f,
          '/women%27s%20clothing': f,
          '/product-id':
        ...
        y = function (e) {
          if (
                  ...
                  (e.forEach(function (e) {
                    return (function (e) {
                      var t = e.id,
                        ...
                        o = e.image,
                        a = e.price;
                      document.querySelector('.all-products__header--name').innerText = r;
                      var c = document.createElement('section');
                      c.classList.add('product__element'),
                        c.classList.add('product__element-id'.concat(t)),
                        (c.innerHTML =
                          '\n                  <figure class="product__border">\n                    <img class="product__img" src="'
                            .concat(
                              o,
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              ...
                              return e.abrupt('return');
                            case 4:
                              return s(c), (e.prev = 5), (e.next = 8), fetch(n);
                            case 8:
                              return (i = e.sent), (e.next = 11), i.json();
                            case 11:
                              (l = e.sent), r(l, c), (e.next = 18);
                              break;
                            case 15:
            ...
            switch (e) {
              case '/login-panel':
                (document.title = 'Online Store - Sign up or Sign in'), (g.innerHTML = v[e]);
                break;
              case '/basket':
                (document.title = 'Online Store - '.concat(e.slice(1))), (g.innerHTML = v[e]);
                break;
              case '/electronics':
                (document.title = 'Online Store - '.concat(e.slice(1))),
                  (g.innerHTML = v[e]),
              ...
              case '/men%27s%20clothing':
                (document.title = 'Online Store - '.concat(decodeURI(e.slice(1)))),
                  (g.innerHTML = v[e]),
                  m('men%27s%20clothing');
                break;
              case '/women%27s%20clothing':
                (document.title = 'Online Store - '.concat(decodeURI(e.slice(1)))),
                  (g.innerHTML = v[e]),
                  m('women%27s%20clothing');
                break;
              default:
                (document.title = 'Online Store'),
                  (g.innerHTML = v['/']),
                  p('products', '.recommend__products', 10),
                  u(14, 2),
                  p('products', '.bestsellers__products', 4),
                  _(5);
            }
          var n, r;
          b();
      ...
      (g.innerHTML = v[window.location.pathname]),
